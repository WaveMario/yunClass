(function(){
	...
	// click关注事件
	var care= document.querySelector(".nav .g-nav-left .care");//关注
	var masklgn= document.querySelector(".g-masklgn");//遮罩
	var fans= document.querySelector(".nav .g-nav-left .g-funs");//粉丝
	...
	function setcare(){
		...
		var cancel= document.querySelector(".nav .g-nav-left .care span");
